...
class SettingAdminController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        return $this->render('cjohnsonContentManagementSystemBundle:Setting:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('cjohnsonContentManagementSystemBundle:Setting:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('cjohnsonContentManagementSystemBundle:Setting')->find($id);
        ...
        return $this->render('cjohnsonContentManagementSystemBundle:Setting:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('cjohnsonContentManagementSystemBundle:Setting:edit.html.twig', array(
            'entity'      => $entity,
